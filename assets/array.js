...
const filmDirectors__list = document.getElementById('filmDirectors__list');
...
filmDirectorName.textContent = item.name;
filmDirectorName.className = 'filmDirectors__name';

const career = document.createElement('p')
career.textContent = item.career;
career.className = 'filmDirectors__career';

const films = document.createElement('a');
films.textContent = "Фильмография";
films.className = 'filmDirectors__films';
films.href = item.films;
films.target = "_blank";

filmDirectors__list.append(listItem);
listItem.append(nameAndCareer, filmography);
nameAndCareer.append(filmDirectorName, career);
